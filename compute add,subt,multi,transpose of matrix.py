...
def accept_matrix(M) :
    print("nEnter the order of the Matrix (row,col) : ")
    r = int(input("trow = "))
    c = int(input("tcol = "))
    print("Enter the elements of the Matrix : n")
    for i in range(r) :
       A = []
       for j in range (c) :
          A.append(int(input()))
       M.append(A)
    print("nMatrix accepted successfullyn")
...
def main():   
   while True :
       print("ttt1: Accept Matrix");
       print("ttt2: Display Matrix");
       print("ttt3: Addition of Matrices");
       print("ttt4: Substraction of Matrices");
       print("ttt5: Multiplication of Matrices");
       print("ttt6: Transpose Matrix");
       print("ttt7: Exit");
